  ...
  return (
    <div>
      <div className="row sm:max-w-xl md:max-w-xl lg:max-w-2xl text-left p-6">
        ...
        <br></br>
        <br></br>
        <p className="mb-5 font-bold">OVERVIEW</p>
        <p className="mb-3">
          This website is operated by{" "}
          <strong>iTap World (ROC : 003499233-M)</strong>. Throughout the site,
          the terms “we”, “us” and “our” refer to <strong>iTap World</strong>.
          <strong>iTap World</strong>
        ...
        <p className=" mt-2 mb-5 font-bold">SECTION 1 - ONLINE STORE TERMS</p>
        <p className="mb-3">
        ...
        <p className=" mt-2 mb-5 font-bold">SECTION 2 - GENERAL CONDITIONS</p>
        <p className="mb-3">
        ...
        <p className=" mt-2 mb-5 font-bold">
        ...
        <p className=" mt-2 mb-5 font-bold">SECTION 7 - OPTIONAL TOOLS</p>
        <p className="mb-3">
        ...
        <p className=" mt-2 mb-5 font-bold">SECTION 8 - THIRD-PARTY LINKS</p>
        <p className="mb-3">
        ...
        <p className=" mt-2 mb-5 font-bold">SECTION 12 - PROHIBITED USES</p>
        <p className="mb-5">
        ...
        <p className="mb-5">
          In no case shall iTap World, our directors, officers, employees,
        ...
        <p className=" mt-2 mb-5 font-bold">SECTION 14 - INDEMNIFICATION</p>
        <p className="mb-5">
          You agree to indemnify, defend and hold harmless iTap World and our
        ...
        <p className=" mt-2 mb-5 font-bold">SECTION 15 - SEVERABILITY</p>
        <p className="mb-5">
        ...
        <p className=" mt-2 mb-5 font-bold">SECTION 16 - TERMINATION</p>
        <p className="mb-3">
        ...
        <p className=" mt-2 mb-5 font-bold">SECTION 17 - ENTIRE AGREEMENT</p>
        <p className="mb-3">
        ...
        <p className=" mt-2 mb-5 font-bold">SECTION 18 - GOVERNING LAW</p>
        <p className="mb-5">
        ...
        <p className=" mt-2 mb-5 font-bold">SECTION 20 - CONTACT INFORMATION</p>
        <p className="mb-3">
